...
print('result_exp ', '^', item_2, '=', result_exp)
...
print('result_m_exp ', '^', item_2, '=', result_m_exp)
...
#  23. Создать переменную result_m_floor и
# result_division округлить до ближайшего целого меньшего чем result_division.
result_m_floor = math.floor(result_division)

#  24. Вывести result_m_floor в консоль.
print('result_m_floor = ', result_m_floor)

#  25. Создать переменную result_m_ceil и result_division округлить
#  до ближайшего целого большего чем result_division.
